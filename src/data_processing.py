...
class DataProcessor:
    ...
    def filter_users(self, min_rating=400):
        """
        min_rating : int : minimum number of ratings a user must have to be included
        Filters out users with fewer than min_rating ratings.
        """
        try:
    ...
    def scale_ratings(self):
        """
        Scales the ratings to a range between 0 and 1.
        """
        try:
    ...
    def encode_data(self):
        """
        Encodes user IDs and anime IDs to sequential integers.
        """
        try:
            # Users
    ...
    def split_data(self, test_size=1000, random_state=43):
        ...
        try:
            ...
            logger.info("Data splitted successfully into train and test sets")
    ...
    def save_artifacts(self):
        """
        Saves the processed artifacts to the output directory.
        ...
        try:
            ...
            # Save each artifact using joblib (save the data with name as filename)
            ...
            # Also save the rating_df as CSV file for reference
    ...
    def process_anime_data(self):
        """
        Processes the anime and anime synopsis data and saves them as CSV files.
        - anime_df.csv
        - synopsis_df.csv
        """
        try:
            ...
            # Fill missing synopsis with "No Synopsis"
            df = df.replace("Unknown", np.nan)

            def getAnimeName(anime_id):
                """
                anime_id : int : MAL_ID of the anime
                Returns the English name of the anime if available, otherwise returns the original name.
                """
                try:
            ...
            # Sort dataframe by Score in descending order (quicksort)
    ...
    def run(self):
        ...
        Executes the sequence of data processing steps.
        - load_data
        - filter_users
        - scale_ratings
        - encode_data
